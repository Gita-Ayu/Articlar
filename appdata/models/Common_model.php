...
class Common_model extends CI_Model {
    ...
    public function generate_html($page_id)
    {
        ...
        $values['body'] = str_replace(['[art-404]','[art-noresult]','[art-results]','<p>[deco-border-end]</p>','<p>[column-end]</p>','[column-end]','<p>[container-end]</p>','[add-columns-here]','<p>[jumbotron-end]</p>'],'',$values['body']);
