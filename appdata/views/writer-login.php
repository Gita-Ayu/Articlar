                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" id="authorLogin">
                    <div class="row">
                        ...
                        <div class="col-12 cross-center mt-3">
                            ...
                            <span class="cross-center" style="margin-left: auto;">Show <i class="art-icon" id="show-hide-password-toggle" style="cursor: pointer;" onclick="showHidePassword('author_secret');">check_box_outline_blank</i></span>
                        </div>
