                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" id="editorLogin">
                    <div class="row">
                        ...
                        <div class="col-12 cross-center space-top-1">
                            ...
                            <span class="cross-center" style="margin-left: auto;">Show Password <i class="art-icon" id="show-hide-password-toggle" style="cursor: pointer;" onclick="showHidePassword('editor_secret');">check_box_outline_blank</i></span>
                        </div>
