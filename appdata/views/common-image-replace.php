...
<div class="container">
    <div class="row space-top">
        <div class="col-12 column center cross-center">
            <div id="picBox" class="picture-box" onclick="triggerField('#image_field');" style="background-image: url(<?php echo base_url($this->config->item('uploadir').'authors/'.$author_id.'/'.$image); ?>); height: 360px; width:360px;">
