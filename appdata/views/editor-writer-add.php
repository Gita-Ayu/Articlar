<div class="container">
    ...
    <form autocomplete="off" name="createAuthor" id="createAuthor" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4 space-top">
                <label>Picture</label>
                <div id="picBox" class="picture-box" onclick="triggerField('#author_profile_picture');">
...
<script>
    ...
    $('document').ready(function(){
        $("#createAuthor").validate({
            rules:
                {
                    author_profile_name   : "required",
                    author_profile_email  : {"required":true,email:true},
                    author_profile_pass	  :	"required"
                },
            messages:
                {
                    author_profile_name   : "Please enter full name",
                    author_profile_email  :	"Valid and active email is required",
                    author_profile_pass	  :	"Password is important"                }
        });
    });
    */
