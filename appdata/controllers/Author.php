...
class Author extends CI_Controller {
    ...
    protected function ajax_processor($request,$type)
    {
//$this->author_model->authenticate();
        $data = $this->author_model->ajax_processor_model($request,$type);
        switch($type)
        {
#Default
            case('card'):
            {
                $html =
                    '
<!-- ARTICLE CARD | '.dash_url($data['title']).' | start -->
<div class="card">
<a href="' . dash_url($data['title']) . '">
<div class="image-stablizer card-2-pic" style="background-image:url(' . base_url('uploadir/authors/' . $_SESSION['author-id'] . '/' . $data['image']) . ');"></div>
</a>  
<h1 class="thin-font" style="height:100px; overflow: hidden;">' . $data['title'] . '</h1>
<p style="padding:0 10px 0 10px; height:200px; overflow: hidden;">' . $data['description'] . '</p>
<a href="' . dash_url($data['title']) . '"><button class="button">READ</button></a>
</div>
<!-- ARTICLE CARD | '.dash_url($data['title']).' | end -->
';
                die($html);
            };break;
            case('card-compact'):
...
<h1 class="thin-font">' . $data['title'] . '</h1>
<p style="padding:0 10px 0 10px;">' . $data['description'] . '</p>
<a href="' . dash_url($data['title']) . '"><button class="button">READ</button></a>
</div>
<!-- ARTICLE CARD | '.dash_url($data['title']).' | end -->
';
...
#Picture plus title only
            case('card-picture-plus-title'):
            {
                $html =
                    '
<!-- ARTICLE CARD | '.dash_url($data['title']).' | start -->
...
';
            ...
            case('card-picture-plus-title-compact'):
            {
                $html =
                    '
<!-- ARTICLE CARD | '.dash_url($data['title']).' | start -->
...
<h1 class="thin-font">' . $data['title'] . '</h1>
<p style="padding:0 10px 0 10px;">' . $data['description'] . '</p>
<a href="' . dash_url($data['title']) . '"><button class="button-small">READ</button></a>
</div>
<!-- ARTICLE CARD | '.dash_url($data['title']).' | end -->
';
                die($html);
...
<h1 style="height:100px; overflow: hidden;">' . $data['title'] . '</h1>
<p style="padding:0 10px 0 10px; height:200px; overflow: hidden;">' . $data['description'] . '</p>
<a href="' . dash_url($data['title']) . '"><button class="button">READ</button></a>
</div>
<!-- ARTICLE CARD | '.dash_url($data['title']).' | end -->
';
            ...
            case('card-3-compact'): {
                $html =
                    '
<!-- ARTICLE CARD | '.dash_url($data['title']).' |-->
<div class="card-3">
<a href="' . dash_url($data['title']) . '">
<div class="image-stablizer card-2-pic" style="background-image:url(' . base_url('uploadir/authors/' . $_SESSION['author-id'] . '/' . $data['image']) . ');"></div>
</a>  
<h1 class="thin-font">' . $data['title'] . '</h1>
<p style="padding:0 10px 0 10px; text-align:center;">' . $data['description'] . '</p>
<a href="' . dash_url($data['title']) . '"><button class="button-small">READ</button></a>
</div>
<!-- ARTICLE CARD | '.dash_url($data['title']).' | end -->
';
            ...
            case('text-only'):
            {
                $html =
                    '
<!-- ARTICLE CARD | '.dash_url($data['title']).' | start -->
<div class="card-3" style="border:0px;">
<a href="' . dash_url($data['title']) . '">
<h1 class="thin-font">' . $data['title'] . '</h1>
</a>
<p style="padding:0 10px 0 10px; text-align:center;">' . $data['description'] . '</p>
